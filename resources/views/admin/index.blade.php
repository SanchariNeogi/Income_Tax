                    ...
                    <div class="nk-sidebar-content">
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ route('addmember.index') }}" class="nk-menu-link">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="./html/index-project.html" class="nk-menu-link">
                                                <span class="nk-menu-text">Project Manage</span>
                                            </a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="./html/index-marketing.html" class="nk-menu-link">
                                                <span class="nk-menu-text">Marketing</span>
                                            </a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="./html/index-nft.html" class="nk-menu-link">
                                                <span class="nk-menu-text">NFT</span>
                                            </a>
                                        </li> --}}
                                    </ul>
                                </li>
                                ...
                                <!----arunisha bera end here for attribute work----->
                                ...
                                <ul class="nk-nav">
                                    {{-- <li class="nk-nav-item has-sub">
                                        ...
                                        <ul class="nk-nav-sub nk-nav-sub-lg">
                                            ...
                                            <li class="nk-nav-item">
                                                <a href="./html/index-ecommerce.html"
                                            ...
                                            <li class="nk-nav-item">
                                                <a href="./html/index-project.html"
                                                    ...
                                                    <div class="media-group flex-grow-1">
                                                        ...
                                                        <div class="media-text flex-grow-1">
                                                            ...
                                                            <span class="sub-text d-block">Tasts, graphs &
                                                                charts</span>
                                                        </div>
                                                    </div><!-- .media-group -->
                                                </a>
                                            ...
                                            <li class="nk-nav-item">
                                                <a href="./html/index-marketing.html"
                                                    ...
                                                    <div class="media-group flex-grow-1">
                                                        ...
                                                        <div class="media-text flex-grow-1">
                                                            ...
                                                            <span class="sub-text d-block">Campaings &
                                                                conversions</span>
                                                        </div>
                                                    </div><!-- .media-group -->
                                                </a>
                                                ...
                                                <a href="./html/index-nft.html"
                                                    ...
                                                    <div class="media-group flex-grow-1">
                                                        ...
                                                        <div class="media-text flex-grow-1">
                                                            ...
                                                            <span class="sub-text d-block">Sell &amp; Create your own
                                                                NFTs</span>
                                                        </div>
                                                    </div><!-- .media-group -->
                                                </a>
                                    ...
                                    <li class="nk-nav-item has-sub">
                                        ...
                                        <ul class="nk-nav-sub">
                                            <li class="nk-nav-item has-sub">
                                                ...
                                                <ul class="nk-nav-sub">
                                                    <li class="nk-nav-item">
                                                        <a href="./html/apps/fullcalendar/calendar.html"
                                                            class="nk-nav-link"> Calendar </a>
                                                    </li>
                                                    <li class="nk-nav-item has-sub">
                                                        <a href="#" class="nk-nav-link nk-nav-toggle"> Kanban
                                                            board </a>
                                                        <ul class="nk-nav-sub">
                                                            <li class="nk-nav-item">
                                                                <a href="./html/apps/kanban/kanban-basic.html"
                                                                    class="nk-nav-link"> Basic </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/apps/kanban/kanban-custom-board.html"
                                                                    class="nk-nav-link"> Custom Board </a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="nk-nav-item has-sub">
                                                        <a href="#" class="nk-nav-link nk-nav-toggle"> User
                                                            Management </a>
                                                        <ul class="nk-nav-sub">
                                                            <li class="nk-nav-item">
                                                                <a href="./html/user-manage/user-list.html"
                                                                    class="nk-nav-link"> Users List </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/user-manage/user-cards.html"
                                                                    class="nk-nav-link"> Users Cards </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/user-manage/user-profile.html"
                                                                    class="nk-nav-link"> Users Profile </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/user-manage/user-edit.html"
                                                                    class="nk-nav-link"> Users Edit </a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="nk-nav-item has-sub">
                                                        <a href="#" class="nk-nav-link nk-nav-toggle"> eCommerce
                                                        </a>
                                                        <ul class="nk-nav-sub">
                                                            <li class="nk-nav-item">
                                                                <a href="./html/ecommerce/products.html"
                                                                    class="nk-nav-link"> Products </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/ecommerce/categories.html"
                                                                    class="nk-nav-link"> Categories </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/ecommerce/add-product.html"
                                                                    class="nk-nav-link"> Add Product </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/ecommerce/edit-product.html"
                                                                    class="nk-nav-link"> Edit Product </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/ecommerce/add-category.html"
                                                                    class="nk-nav-link"> Add Category </a>
                                                            </li>
                                                            <li class="nk-nav-item">
                                                                <a href="./html/ecommerce/edit-category.html"
                                                                    class="nk-nav-link"> Edit Category </a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li class="nk-nav-item">
                                                <a href="./html/components/data-tables.html" class="nk-nav-link"> Data
                                                    tables </a>
                                            </li>
                                            <li class="nk-nav-item">
                                            ...
                                            <li class="nk-nav-item">
                                                <a href="./html/components/sweet-alert.html" class="nk-nav-link">
                                                    Sweetalert </a>
                                            </li>
                                            <li class="nk-nav-item">
                                                <a href="./html/auths/auth-register.html" class="nk-nav-link"
                                                    target="_blank"> Auth Register </a>
                                            </li>
                                            <li class="nk-nav-item">
                                                <a href="./html/auths/auth-login.html" class="nk-nav-link"
                                                    target="_blank"> Auth Login </a>
                                            </li>
                                            <li class="nk-nav-item">
                                                <a href="./html/auths/auth-reset.html" class="nk-nav-link"
                                                    target="_blank"> Forgot Password </a>
                                            </li>
                                            <li class="nk-nav-item">
                                                <a href="./html/error/page-404.html" class="nk-nav-link"
                                                    target="_blank"> Page 404 </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nk-nav-item has-sub">
                                            ...
                                            <div class="nk-nav-mega nk-nav-mega-lg">
                                                <div class="nk-nav-col">
                                                    ...
                                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                                        ...
                                                        <li>
                                                            <a href="./html/components/button-group.html">Button
                                                                group</a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a href="./html/components/close-button.html">Close
                                                                button</a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a
                                                                href="./html/components/placeholders.html">Placeholders</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="nk-nav-col nk-nav-media">
                                                    <img src="{{ asset('images/thumb/a.jpg') }}" alt="" class="rounded-3">
                        </div><!-- .nk-nav-col -->
                    </div><!-- .nk-nav-mega -->
                </div>
                </li> --}}
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-md">
                                <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                    <div class="media-group">
                                        <div class="media media-xl media-middle media-circle"><img src="{{ asset('images/avatar/a.jpg') }}" alt="" class="img-thumbnail"></div>
                                        <div class="media-text">
                                ...
                                <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                    <ul class="link-list">
                                        <li><a href="./html/profile.html"><em class="icon ni ni-user"></em> <span>My
                                                    Profile</span></a></li>
                                        <li><a href="./html/user-manage/user-cards.html"><em class="icon ni ni-contact"></em> <span>My
                                                    Contacts</span></a></li>
                                        <li><a href="./html/profile-edit.html"><em class="icon ni ni-setting-alt"></em> <span>Account
                                                    Settings</span></a></li>
                                    </ul>
                                </div>
                                <div class="dropdown-content dropdown-content-x-lg py-3">
                        ...
                        <ul class="d-flex flex-wrap gap g-2 py-2">
                            <li>
                                <div class="media media-xxl">
                                    <img src="{{ asset('images/product/a.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                            </li>
                            <li>
                                <div class="media media-xxl">
                                    <img src="{{ asset('images/product/b.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                            </li>
                            <li>
                                <div class="media media-xxl">
                                    <img src="{{ asset('images/product/c.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="list-group-dotted mt-3">
                            <div class="list-group-wrap">
                                <div class="p-3">
                                    <div class="media-group">
                                        <div class="media rounded-0">
                                            <img src="{{ asset('images/icon/file-type-pdf.svg') }}" alt="">
                                        </div>
                                ...
                                <div class="p-3">
                                    <div class="media-group">
                                        <div class="media rounded-0">
                                            <img src="{{ asset('images/icon/file-type-doc.svg') }}" alt="">
                                        </div>
                                        <div class="media-text ms-1">
                                ...
                                <div class="p-3">
                                    <div class="media-group">
                                        <div class="media rounded-0">
                                            <img src="{{ asset('images/icon/file-type-code.svg') }}" alt="">
                                        </div>
                                        <div class="media-text ms-1">
...
<script>
    $(document).ready(function() {
        $('#viewdetailsModal').on('show.bs.modal', function(e) {
            ...
            modal.find("#profile_picture").attr('src', image ||
    ...
    $(document).ready(function() {
        $('#editdetailsModal').on('show.bs.modal', function(e) {
            var link = $(e.relatedTarget),
                modal = $(this),
                // username = link.data("details"),
                email = link.data("email");
        ...
        $("#submit_edit").on('click', function() {
            ...
            var form = $("#member_edit_form")[0];
            var data_post = new FormData(form);
            $.ajax({
                url: "{{ route('addmember.update', '1') }}",
                type: 'POST',
                data: data_post,
                contentType: false,
                processData: false,
